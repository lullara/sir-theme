...
#mysubmenu{margin: 0 auto; position: absolute; top: 0px;}
#mysubmenu ul#snb{}
#mysubmenu ul.snb2dul{height: 80px;}
#snb .snb2dul > li.active,#snb .snb2dul > li:hover{background-color: #0f7ab0; width: 210px;}
#snb .snb2dul > li.active,#snb .snb2dul > li a:hover{color:#fff;}

/*#mysubmenu ul.snb2dul:after{content: ''; clear: both; display: block;}*/
#mysubmenu ul.snb2dul li{display:inline-block; width: 210px; height: 70px; background-color: #fff;border: 1px solid #0f7ab0;margin-right: -5px; border-bottom: 0 solid none !important;}
/*#mysubmenu ul.snb2dul li:last-child{margin-right: 0;}*/
/*#mysubmenu ul.snb2dul li.active{width: 280px; background-color: #eee;}*/
#mysubmenu ul.snb2dul li.snb2d a{ display: block; line-height: 70px; color:#333; font-size: 16px; text-align: center;}
#mysubmenu ul.snb2dul li.snb2d.active a{color:#fff;}
//-->
</style>

<div id="mysubmenu">
    <?php /* 주의사항 아래 ,lklk;k;코드를 수정하시면 페이지 현재위치 및 서브메뉴,모바일메뉴가 정상작동되지 않을 수 있습니다. */ ?>
		<ul id="snb">
